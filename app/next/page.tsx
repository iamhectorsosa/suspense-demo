    ...
    return (
        <section className="space-y-4">
            ...
            <ul className="prose:slate dark:prose-inver prose min-w-full list-disc space-y-2 pl-4 text-justify">
                ...
                <li>
                    Shared layouts remain interactive while nested layouts or
                    pages load.
                </li>
                <li>
                    Navigation is interruptible. Try navigating to one category,
                    then clicking a second category before the first one has
                    loaded.
                </li>
            </ul>
        </section>
